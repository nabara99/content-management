<div>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Kelola semua instansi yang terdaftar</p>
        </div>
    ...
    <div class="mb-4">
        <div class="relative max-w-sm">
            ...
            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari instansi..."
            ...
            <table class="w-full min-w-[500px]">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase">Nama Instansi</th>
                        <th class="text-center px-6 py-3 text-xs font-medium text-gray-500 uppercase">Jumlah User</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($instances as $index => $instance)
                        <tr class="hover:bg-gray-50 transition-colors" wire:key="instance-{{ $instance->id }}">
                            <td class="px-6 py-4 text-sm text-gray-400">{{ $instances->firstItem() + $index }}</td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <span class="text-sm font-medium text-gray-900">{{ $instance->name }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-500 text-center">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $instance->users_count > 0 ? 'bg-blue-50 text-blue-700' : 'bg-gray-100 text-gray-500' }}">
                                    {{ $instance->users_count }}
                                </span>
                            </td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    <button wire:click="openEditModal({{ $instance->id }})"
                                    ...
                                    <button wire:click="confirmDelete({{ $instance->id }})"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <p class="text-sm text-gray-400">Belum ada instansi terdaftar.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4" x-data x-init="document.body.style.overflow='hidden'" x-on:remove="document.body.style.overflow=''">
        ...
        <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6 z-10">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-lg font-bold text-gray-900">Tambah Instansi Baru</h2>
            ...
            <form wire:submit="create" class="space-y-4">
                <div>
                    ...
                    <input type="text" wire:model="name" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm" placeholder="Contoh: Dinas Pendidikan">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6 z-10">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-lg font-bold text-gray-900">Edit Instansi</h2>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 z-10 text-center">
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-2">Hapus Instansi?</h3>
            <p class="text-sm text-gray-500 mb-6">Instansi yang dihapus tidak dapat dikembalikan.</p>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6 z-10">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-lg font-bold text-gray-900">Import Instansi dari Excel</h2>
            ...
            <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-xl">
                <p class="text-xs text-blue-700 mb-2">Download template terlebih dahulu. Kolom: name (nama instansi).</p>
